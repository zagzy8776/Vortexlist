...
-- CreateEnum
CREATE TYPE "ProductCategory" AS ENUM ('PROXY', 'PHONE_NUMBER', 'ESIM');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'PAID', 'FULFILLING', 'FULFILLED', 'FAILED', 'CANCELLED', 'REFUNDED');

-- CreateEnum
CREATE TYPE "WalletTransactionType" AS ENUM ('DEPOSIT', 'PURCHASE', 'REFUND', 'ADMIN_CREDIT', 'ADMIN_DEBIT');
...
CREATE TABLE "Product" (
    ...
    "fixedMarkupUsd" DECIMAL(65,30) NOT NULL DEFAULT 0,
